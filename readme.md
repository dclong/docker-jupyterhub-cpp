# dclong/jupyterhub-cpp [@DockerHub](https://hub.docker.com/r/dclong/jupyterhub-cpp/) | [@GitHub](https://github.com/dclong/docker-jupyterhub-cpp)
...
docker run -d \
    ...
    dclong/jupyterhub-cpp /scripts/sys/init.sh
```
